...
- [ ] 1.2 [P] Add tests for `WhisperClient.transcribe()` with language and prompt parameters
...
- [ ] 2.3 Add API endpoint tests for language and prompt query parameters on both endpoints
